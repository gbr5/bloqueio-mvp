...
export function AuthModal({ isOpen, onClose, onSuccess }: AuthModalProps) {
  ...
  const handleOAuthSignIn = async (provider: "google" | "github") => {
    ...
    try {
      ...
      setError(`Falha ao entrar com ${provider}`);
      setLoading(false);
    }
  };
      ...
      <div className="bg-slate-800 border border-slate-700 rounded-xl p-8 max-w-md w-full mx-4 shadow-2xl">
        ...
        <div className="space-y-3 mb-6">
          <button
            ...
            disabled={loading}
            className="w-full py-3 px-4 bg-white hover:bg-gray-100 text-gray-800 font-medium rounded-lg transition-colors flex items-center justify-center gap-3 disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 px-4 bg-slate-700 hover:bg-slate-600 text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-3 disabled:opacity-50"
          >
